 ...
 * </ul>
 *
 * <div><div>Related Topics</div><div><li>贪心</li><li>数组</li></div></div><br><div><li>👍 1627</li><li>👎 0</li></div>
 */
public class GasStation134 {
    public static void main(String[] args) {
        Solution solution = new GasStation134().new Solution();
    }
    ...
    class Solution {
        public int canCompleteCircuit(int[] gas, int[] cost) {
            /*
            遍历从每一个加油站出发的情况，
            满足  当前油量 （总汽油数-总汽油花费）>=0，全局最优 从而获得结果，返回；
            如果在任意时刻 不满足上面的条件，从下一个加油站重新出发；
            如果都不满足，return -1；
             */
